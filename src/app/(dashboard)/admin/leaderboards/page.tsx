...
import { Search, Crown, Medal, Gem, TrendingUp, Zap, Award, Eye } from 'lucide-react';
    ...
    return (
        <PageContainer>
            <PageHeader
                ...
                description="Read-only view — top-ranked hosts, highest earners, and most-gifted creators"
                actions={
